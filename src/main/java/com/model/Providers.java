...
public class Providers {
 ...
 public Providers(Integer providerId, String firstName, String typeProvider, String middleInitial, String lastName,
   String streetAdress, String city, String state, String zip, String phone, String alternatePhone,
   Integer status, Date created, Integer createdBy, Date modified, Integer modifiedBy, String deviceId,
   Integer activationCode, String chatId, String profileImageUrl) {
  super();
